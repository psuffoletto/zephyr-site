...
export const beddingProducts: Product[] = [
  ...
  },
  {
    ...
    features: [
      { title: 'Rainfall Dispensing', desc: 'Rainfall-style dispensing method provides uniform, even distribution of bedding material for consistent cage filling across all positions.' },
