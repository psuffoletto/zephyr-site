...
export const beddingProducts: Product[] = [
  // ── DELIVERY ──
  {
    ...
    modelNumber: 'LX',
    category: 'delivery',
    heroImage: '/images/lx-hero.png',
    productImage: '/images/lx-render.png',
  ...
  },
  {
    ...
    modelNumber: 'MX',
    category: 'delivery',
    heroImage: '/images/mx-hero.jpg',
    productImage: '/images/mx-render.png',
  ...
  },
  {
    ...
    modelNumber: 'VX',
    category: 'delivery',
    heroImage: '/images/vx-hero.png',
    productImage: '/images/vx-render.png',
  ...
  // ── DISPENSING ──
  {
    ...
    modelNumber: '504',
    category: 'dispensing',
    heroImage: '/images/504-hero.jpg',
    productImage: '/images/504-render.png',
  ...
  },
  {
    ...
    productImage: '/images/gf-render.png',
    accentLabel: 'Waste Handling',
