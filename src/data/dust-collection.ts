...
export const dustCollectionProducts: Product[] = [
  // ── CARTRIDGE COLLECTORS ──
  {
    ...
    description: 'The IR2-4 is a compact, high-efficiency cartridge dust collector designed for industrial dust collection and process air filtration applications. Featuring a four-cartridge configuration rated for 1,000 CFM, the IR2-4 delivers reliable particulate capture in a space-efficient footprint, with pulse-jet filter cleaning for continuous operation and low maintenance.',
    keySpecs: [
      { value: '4', label: 'Cartridges' },
      { value: '1,000', label: 'CFM' },
      { value: 'Pulse Jet', label: 'Filter Clean' },
      { value: 'Compact', label: 'Footprint' },
    ],
    features: [
      { title: 'High-Efficiency Cartridge Filtration', desc: 'Four pleated cartridge filters provide high surface area for efficient particulate capture across a wide range of industrial dust types.' },
